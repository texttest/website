...
<div class="Text_Normal">
In addition, we measure the coverage of these tests every night also, and the results are posted <a class="Text_Link" href="http://www.texttest.org/nightjob/coverage/index.html">here</A>. As well as the 1000 or so public tests for TextTest there are about 200 tests that go via Jeppesen-specific configuration modules, and we also measure coverage of the core modules with these tests included, which is of course generally a bit higher. This allows you to tell the difference between untested code and code which can't be tested outside Jeppesen.
This extended coverage report can be found <a class="Text_Link" href="http://www.texttest.org/nightjob/coverage_with_jeppesen_tests/index.html">here</A>.
</div>
<div class="Text_Normal">
