...
<table class="Table_Normal">
 <tr>
  <td>
   ...
   <div class="Text_Normal">
     To get hold of the latest version, you will need to install the <a class="Text_Link" href="http://bazaar-vcs.org">Bazaar version control tool</A>. You can then just do "bzr branch lp:storytext" to get the latest code.
   </div>
   <div class="Text_Header">Contributing to StoryText: the tests and documentation</div>
   <div class="Text_Normal">
     StoryText is a work in progress and it doesn't support everything you could ever do in PyGTK or Tkinter. It supports what its users have needed so far, and there is a complete list of what is currently supported here for <a class="Text_Link" href="index.php?page=ui_testing&n=storytext_supported_gtk">PyGTK</A>, <a class="Text_Link" href="index.php?page=ui_testing&n=storytext_supported_tkinter">Tkinter</A>, <a class="Text_Link" href="index.php?page=ui_testing&n=storytext_supported_wx">wxPython</A> and <a class="Text_Link" href="index.php?page=ui_testing&n=storytext_supported_swt">SWT/Eclipse RCP</A> respectively. You are therefore reasonably likely to find that some widget in your application isn't supported, and you are of course encouraged to submit any changes you make back here. Adding functionality isn't just a matter of writing code: new code also needs to be tested and documented before it's complete. You should therefore get the latest version of the tests also, this is done via "bzr branch lp:/~geoff.bache/storytext/selftest-trunk". You can then run your changes against these tests and add new tests if you add new functionality.
   </div>
   <div class="Text_Normal">
