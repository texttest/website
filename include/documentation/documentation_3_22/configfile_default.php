...
<TABLE bgcolor="#666666" cellpadding=1 cellspacing=1>
	...
	<TR VALIGN=TOP>
		...
		<TD bgcolor="#FFFFFF"> 
			<div class="Table_Text_Small">builtin : config, environment, testsuite, options, interpreter_options, stdin, knownbugs<BR>default : &lt;empty&gt;<BR>regenerate : usecase</div>
		</TD>
		<TD bgcolor="#FFFFFF">
