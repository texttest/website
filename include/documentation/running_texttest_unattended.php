...
HTML report rather than have one of the <A class="Text_Link" href="interfaces.html">interactive
...
the <A class="Text_Link" href="dirstructure.html#Appendix - TextTest file formats">file
...
<div class="Text_Normal"><IMG src="include/documentation/images/batch.JPG" NAME="Graphic1" ALIGN=RIGHT WIDTH=643 HEIGHT=548 BORDER=0><BR CLEAR=RIGHT><BR><BR>
</div>
...
nice in reports.</div>
<div class="Text_Normal">The &ldquo;details&rdquo; section consists of the <A class="Text_Link" href="interfaces.html#diff_program">textual
...
<div class="Text_Header"><A NAME="batch_result_repository"></A><A NAME="historical_report_location"></A><A NAME="testoverview_colours"></A><A NAME="batch.GenerateHistoricalReport"></A><A NAME="batch.ArchiveRepository"></A>
...
script is also run when the -coll flag is provided, see below.</div>

<div class="Text_Normal">The easiest way to get a handle on what this looks like is to
look at this <A class="Text_Link" href="htmlreport_example/test_batch.html">example</A>,
...
see how to set this, look at the <A class="Text_Link" href="configfile.html">config
...
if <A class="Text_Link" href="sysresource.html">performance testing is enabled for
CPU time</A>.</div>
<div class="Text_Normal">More generically, you can use the &ldquo;batch_filter_file&rdquo;
entry to identify <A class="Text_Link" href="interfaces.html#-f">filter files</A>
...
<div class="Text_Normal">Both of these things act in concert with any <A class="Text_Link" href="interfaces.html#-t">test
selection filters</A> selected on the command line or from the
static GUI. As described there, only tests which satisfy <U>all</U>
...
<div class="Text_Normal"><IMG src="include/documentation/images/batchconfig.JPG" NAME="Graphic3" ALIGN=LEFT WIDTH=502 HEIGHT=483 BORDER=0><BR CLEAR=LEFT><BR>
</div>
...
<A class="Text_Link" href="autointerpret.html">automatic failure interpretation</A>
