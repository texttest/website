...
nice in reports.</div>
<div class="Text_Normal">The &ldquo;details&rdquo; section consists of the <A class="Text_Link" href=<?php print "\"index.php?page=".$version."&n=guide_to_texttest_ui"; ?>#diff_program">textual
...
entry to identify <A class="Text_Link" href=<?php print "\"index.php?page=".$version."&n=guide_to_texttest_ui"; ?>#-f">filter files</A>
...
<div class="Text_Normal">Both of these things act in concert with any <A class="Text_Link" href=<?php print "\"index.php?page=".$version."&n=guide_to_texttest_ui"; ?>#-t">test
