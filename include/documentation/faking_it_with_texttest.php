...
purposes.</div>
<div class="Text_Normal">(All the following mechanisms involve the <A class="Text_Link" href="tempdir.html">test
...
<OL>
	...
	can simply define it as <A class="Text_Link" href="tempdir.html#copy_test_path">editable
...
<div class="Text_Normal">When TextTest creates the t<A class="Text_Link" href="tempdir.html">emporary
...
run instead of their real versions via the normal t<A class="Text_Link" href="tempdir.html#link_test_path">est
