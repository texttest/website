...
<TABLE bgcolor="#666666" cellpadding=1 cellspacing=1>
	...
	<TR VALIGN=TOP>
		...
		<TD bgcolor="#FFFFFF"> 
			<div class="Table_Text_Small">None</div>
		</TD>
		<TD bgcolor="#FFFFFF">
	...
	<TR VALIGN=TOP>
		...
		<TD bgcolor="#FFFFFF">
			<div class="Table_Text_Small">Configuration module to use</div>
		</TD>
	</TR>
	<TR VALIGN=TOP>
		<TD bgcolor="#FFFFFF">
	...
	<TR VALIGN=TOP>
		<TD bgcolor="#FFFFFF">
			<div class="Table_Text_Small">diagnostics</div>
		</TD>
		<TD bgcolor="#FFFFFF">
			<div class="Table_Text_Small">Dictionary</div>
		</TD>
		<TD bgcolor="#FFFFFF"> 
			<div class="Table_Text_Small">configuration_file_variable : &lt;empty&gt;<BR>trace_level_variable : &lt;empty&gt;<BR>write_directory_variable : &lt;empty&gt;</div>
		</TD>
		<TD bgcolor="#FFFFFF">
			<div class="Table_Text_Small"><A class="Text_Link_Small" HREF="index.php?page=<?php echo $version ?>&n=making_the_logging_configurable#diagnostics">Dictionary to define how SUT diagnostics are used</A></div>
		</TD>
	</TR>
	<TR VALIGN=TOP>
		<TD bgcolor="#FFFFFF">
	...
	<TR VALIGN=TOP>
		...
		<TD bgcolor="#FFFFFF"> 
			<div class="Table_Text_Small">10</div>
		</TD>
		<TD bgcolor="#FFFFFF">
	...
	<TR VALIGN=TOP>
		...
		<TD bgcolor="#FFFFFF">
			<div class="Table_Text_Small"><A class="Text_Link_Small" HREF="index.php?page=<?php echo $version ?>&n=texttest_sandbox#test_data_searchpath">Locations to search for test data if not present in test structure</A></div>
		</TD>
	</TR>
	<TR VALIGN=TOP>
		<TD bgcolor="#FFFFFF">
