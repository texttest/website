...
<TABLE bgcolor="#666666" cellpadding=1 cellspacing=1>
	...
	<TR VALIGN=TOP>
		<TD  bgcolor="#FFFFFF">
			<div class="Table_Text_Small">batch.GenerateHistoricalReport</div>
		</TD>
		<TD bgcolor="#FFFFFF">
	...
	<TR VALIGN=TOP>
		...
		<TD bgcolor="#FFFFFF">
			<div class="Table_Text_Small">Lists all files with version IDs that are equivalent to a non-versioned file</div>
		</TD>
	</TR>
	<TR VALIGN=TOP>
		<TD  bgcolor="#FFFFFF">
