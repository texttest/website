<div class="Text_Header" >Running tests in parallel on a grid: The &ldquo;queuesystem&rdquo; configuration </div>
					...
					<div class="Text_Normal"><IMG SRC="<?php echo $basePath; ?>images/parallel.JPG"> Some
					...
					is as follows:</div>
					<OL>
						<LI><div class="Text_Normal">If the option &ldquo;Request
						SGE/LSF queue&rdquo; has been filled in (-q on the command
						line), that queue will be used.</div>
						<LI><div class="Text_Normal">If the config file setting
