...
<div class="Text_Normal"><U>Example configuration (log4py)</U>. Assumes the SUT
...
<div class="Text_Normal">[diagnostics]
configuration_file_variable:DIAG_INPUT
write_directory_variable:DIAG_OUTPUT</PRE><div class="Text_Normal">
<U>Example 2 (log4j).</U> Assumes the SUT reads the local
...
properties_file:log4jconf</PRE><div class="Text_Header">
