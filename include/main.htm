<!--TITLE:Home PAGEINFO:The main page of the site with introduction and small site indexPATH:page=main-->
<table class="Table_Normal">
 <tr>
  <td>
   <div class="Text_Main_Header">Welcome to the home of Texttest</div>
   ...
   <A class="Text_Link" HREF="http://www.sourceforge.net/projects/texttest/">SourceForge
   project page</A> 
   </div>
   ...
   <table class="index">
     <tr valign=top>
      ...
      <tr valign=top>
       <td width=50><div class="Text_Normal" ><a href="index.php?page=documentation" class="Text_Link">Documentation</a><div></td><td><div class="Text_Normal">Tutorials, User Manual and Configuration Reference Manual</div></td>
      </tr>
      <tr valign=top>
