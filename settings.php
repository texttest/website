...
//Used to find documentation for old versions
$pathToOldDocs="http://texttest.carmen.se/old_version/TextTest/docs";

//Current release here
$current_release = "3.24";

//List of all versions
$all_releases = array();
array_push($all_releases, "trunk");
array_push($all_releases, "3.24");
array_push($all_releases, "3.23");
array_push($all_releases, "3.22");
array_push($all_releases, "3.21");
...
array_push($all_releases, "3.14");
array_push($all_releases, "3.13");
array_push($all_releases, "3.12");
array_push($all_releases, "3.11.1");
